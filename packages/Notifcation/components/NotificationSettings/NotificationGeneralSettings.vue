    ...
    <v-card>
      ...
      <v-list tow-line>
        ...
        <v-list-item class="mb-14" width="100%">
          ...
          <v-list-item-content>
            <v-spacer></v-spacer>
            <v-list-item-subtitle class="marginRight">
              10 Days
            ...
            <v-switch
              ...
              :disabled="
                deletePageSittings.Immediately ||
                deletePageSittings.never ||
                deletePageSittings.twoWeeks
              "
              inset
              color="info"
              value="10"
          ...
          <v-list-item-content>
            <v-list-item-subtitle class="marginImmediately1">
              Immediately
            </v-list-item-subtitle>
            <v-switch
          ...
          <v-list-item-content class="mr-15">
            <v-list-item-subtitle class="marginNever">
              never
            </v-list-item-subtitle>
            <v-switch
              class="marginNever"
