...
export default {
  ...
  methods: {
    ...
    tasksSettings(item, id) {
      console.log("active here", item.active);
      console.log("reminder here", item.reminderAfterOneHour);
      if (!this.tasksSettingsValues.includes(item)) {
        this.tasksSettingsValues.push(item);
      }
      if (item.reminderAfterOneHour) {
        this.tasksSettingsValues[id].reminderAfterOneHour =
          item.reminderAfterOneHour;
      }
      // here create the request
      console.log("this is the array", this.tasksSettingsValues);
